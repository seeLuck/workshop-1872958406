...
if GetModConfigData("natureSpawn") == 1 then
    prefabs.wasphive = 2
    prefabs.beehive = 3
    prefabs.houndmound = 3
    prefabs.pighouse = 5
    prefabs.mermhouse = 2
    prefabs.catcoonden = 2
    prefabs.spiderden = 5
    prefabs.tallbirdnest = 2
    prefabs.tentacle = 10
    prefabs.beefalo = 3
    prefabs.lightninggoat = 2
    prefabs.pigtorch = 2
    prefabs.knight = 1
    prefabs.bishop = 1
    prefabs.rook = 1
    ...
    prefabs.green_mushroom = 5
    prefabs.red_mushroom = 5
    prefabs.fireflies = 100
    prefabs.slurtlehole = 3
    prefabs.flower_cave = 50
    prefabs.spiderhole = 10
    prefabs.rabbithouse = 5
    prefabs.reeds = 10
    prefabs.cactus = 10
